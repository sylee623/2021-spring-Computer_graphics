...
'''
C.Use de Casteljau’s Algorithmto compute Bezier curve.
D.In your modified program, control points p0, p1, p2, p3 should be draggable and rendered in green.
E.Draw the edges of the control polygon in green as well
'''
def Lerp(t, q0, q1):
    return (1-t)*q0 + t*q1
